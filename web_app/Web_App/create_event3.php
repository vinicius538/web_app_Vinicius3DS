<?php
  ...
  include_once('API/google_maps.php');
?>
          ...
          <form action="home.php" method="POST" enctype="multipart/form-data">
              <div class="col-8 mx-auto" style="background-color: white; margin-top: 30px; padding-bottom: 40px;">
                  ...
                  <div class="row">
                    ...
                    <select id="estados" style=' margin-left: 130px; width:230px;height:30px'>
                    ...
                    <br><br>
                      ...
                      <select id="municipios"  style=' margin-left: 130px; width:230px;height:30px'>
